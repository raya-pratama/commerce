export default function Hero() {
  return (
    <section id="beranda" className="relative w-full bg-muted  overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 relative">
            ...
            {/* Hiasan Oren 2 */}
            <div className="absolute z-20 -top-6 -right-2 w-20 h-20 bg-[#FF8C00] rounded-full shadow-lg animate-bounce delay-100 hidden sm:block"></div>
